...
2021 Turtleback Expedition T3 Overland Trailer — Fully Loaded, Camp-Ready

**Category:** RVs & Campers > Travel Trailers

**Price:** $34,900

**Description:**

**What is this?** A Turtleback Expedition T3 is a premium overland trailer designed for off-road adventure and extended off-grid camping. Think of it as a base camp you can tow behind your truck or SUV — everything you need to live comfortably in remote locations.

**Why is this one special?** This is a fully-loaded example with the top-tier T3 package plus key upgrades. It's a complete, camp-ready setup — no need to add anything.

**Key Features:**
- **Sleeps 2** in a rooftop clamshell tent (Bush Company Alpha — spacious and easy to set up)
...
**Full specs, photos, and details:** https://miccohadje.github.io/turtleback-for-sale/

**Contact:** Clay Mahaffey | (912) 434-7067 | turtlebackforsale@mahaffey.org

**Best first message:** Tell me your tow vehicle, location, and timeline — I'll answer all your questions.
